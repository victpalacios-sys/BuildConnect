[Skip to main content](https://docs.thatopen.com/intro#__docusaurus_skipToContent_fallback)
...
- [🧩 Components](https://docs.thatopen.com/intro)

- [🔥 Fragments](https://docs.thatopen.com/intro)

- [👩🏻‍🏫 Tutorials](https://docs.thatopen.com/intro)
...
## 🚀 Getting Started [​](https://docs.thatopen.com/intro\#-getting-started "Direct link to 🚀 Getting Started")

### 💪🏻 What you can do [​](https://docs.thatopen.com/intro\#-what-you-can-do "Direct link to 💪🏻 What you can do")
...
### 📋 What you'll need [​](https://docs.thatopen.com/intro\#-what-youll-need "Direct link to 📋 What you'll need")
...
#### 🏢 BIM... [​](https://docs.thatopen.com/intro\#-bim "Direct link to 🏢 BIM...")
...
#### 🧑🏻‍💻 ...Software [​](https://docs.thatopen.com/intro\#-software "Direct link to 🧑🏻‍💻 ...Software")
...
## 🐞 Reporting bugs [​](https://docs.thatopen.com/intro\#-reporting-bugs "Direct link to 🐞 Reporting bugs")
...
## 📚 Navigating the docs [​](https://docs.thatopen.com/intro\#-navigating-the-docs "Direct link to 📚 Navigating the docs")
...
### 🧩 Components [​](https://docs.thatopen.com/intro\#-components "Direct link to 🧩 Components")

Everything in these libraries are **Components**. Here, you will learn [the basics](https://docs.thatopen.com/components/getting-started) and how to import, use and even [create your own custom components](https://docs.thatopen.com/components/creating-components). You will also find some useful [tutorial paths](https://docs.thatopen.com/components/tutorial-paths) that will help you progress throughout these docs!

* * *

### 📋 API [​](https://docs.thatopen.com/intro\#-api "Direct link to 📋 API")
...
### 👩🏻‍🏫 Tutorials [​](https://docs.thatopen.com/intro\#-tutorials "Direct link to 👩🏻‍🏫 Tutorials")

**Step by step tutorials** covering how to use different components, including a live application where you can see it in action. This is the best way to get your feet wet with the libraries. Check out the recommended [tutorial paths](https://docs.thatopen.com/components/tutorial-paths)!

## 🤝 Want our help? [​](https://docs.thatopen.com/intro\#-want-our-help "Direct link to 🤝 Want our help?")
...
- [🚀 Getting Started](https://docs.thatopen.com/intro#-getting-started)
  - [💪🏻 What you can do](https://docs.thatopen.com/intro#-what-you-can-do)
  - [📋 What you'll need](https://docs.thatopen.com/intro#-what-youll-need)
- [🐞 Reporting bugs](https://docs.thatopen.com/intro#-reporting-bugs)
- [📚 Navigating the docs](https://docs.thatopen.com/intro#-navigating-the-docs)
  - [🧩 Components](https://docs.thatopen.com/intro#-components)
  - [📋 API](https://docs.thatopen.com/intro#-api)
  - [👩🏻‍🏫 Tutorials](https://docs.thatopen.com/intro#-tutorials)
- [🤝 Want our help?](https://docs.thatopen.com/intro#-want-our-help)
