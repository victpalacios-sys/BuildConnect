[Skip to main content](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements#__docusaurus_skipToContent_fallback)
...
- [🧩 Components](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements)

- [🔥 Fragments](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements)

- [👩🏻‍🏫 Tutorials](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements)
  ...
  - [Fragments](https://docs.thatopen.com/Tutorials/Fragments/)
    ...
    - [Fragments](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements)
      ...
      - [FragmentsModels](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/)
        ...
        - [BuildingConfigurator](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/BuildingConfigurator)
        - [EditApi](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditApi)
        - [EditElements](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements)
        - [EditProperties](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditProperties)
        - [Materials](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/Materials)
        - [ModelInformation](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/ModelInformation)
        - [Raycasting](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/Raycasting)
        - [Rebars](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/Rebars)
        - [SteelDetailing](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/SteelDetailing)
        - [VisibilityOperations](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/VisibilityOperations)
      - [IfcImporter](https://docs.thatopen.com/Tutorials/Fragments/Fragments/IfcImporter/)
...
Copying and pasting? We've got you covered! You can find the full source code of this tutorial [here](https://github.com/ThatOpen/engine_fragment/blob/main/packages/fragments/src/FragmentsModels/examples/EditElements/example.ts).

## Editing BIM Elements 🪑 [​](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements\#editing-bim-elements- "Direct link to Editing BIM Elements 🪑")
...
### 🖖 Importing our Libraries [​](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements\#-importing-our-libraries "Direct link to 🖖 Importing our Libraries")
...
### 🌎 Setting up a Simple Scene [​](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements\#-setting-up-a-simple-scene "Direct link to 🌎 Setting up a Simple Scene")
...
### 🛠️ Setting Up Fragments [​](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements\#%EF%B8%8F-setting-up-fragments "Direct link to 🛠️ Setting Up Fragments")
...
### 📂 Loading a Fragments Model [​](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements\#-loading-a-fragments-model "Direct link to 📂 Loading a Fragments Model")
...
### ✏️ Setting up the model editor [​](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements\#%EF%B8%8F-setting-up-the-model-editor "Direct link to ✏️ Setting up the model editor")
...
### 🧩 Adding User Interface (optional) [​](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements\#-adding-user-interface-optional "Direct link to 🧩 Adding User Interface (optional)")
...
### ⏱️ Measuring the performance (optional) [​](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements\#%EF%B8%8F-measuring-the-performance-optional "Direct link to ⏱️ Measuring the performance (optional)")
...
### 🎉 Congratulations! [​](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements\#-congratulations "Direct link to 🎉 Congratulations!")
...
[Previous\\
\\
EditApi](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditApi) [Next\\
\\
EditProperties](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditProperties)

- [Editing BIM Elements 🪑](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements#editing-bim-elements-)
  - [🖖 Importing our Libraries](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements#-importing-our-libraries)
  - [🌎 Setting up a Simple Scene](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements#-setting-up-a-simple-scene)
  - [🛠️ Setting Up Fragments](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements#%EF%B8%8F-setting-up-fragments)
  - [📂 Loading a Fragments Model](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements#-loading-a-fragments-model)
  - [✏️ Setting up the model editor](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements#%EF%B8%8F-setting-up-the-model-editor)
  - [🧩 Adding User Interface (optional)](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements#-adding-user-interface-optional)
  - [⏱️ Measuring the performance (optional)](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements#%EF%B8%8F-measuring-the-performance-optional)
  - [🎉 Congratulations!](https://docs.thatopen.com/Tutorials/Fragments/Fragments/FragmentsModels/EditElements#-congratulations)
